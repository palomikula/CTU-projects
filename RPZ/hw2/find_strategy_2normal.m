...
Coef(3) = 2*(distribution1.Sigma^2)*(distribution2.Sigma^2)*log((distribution2.Prior*distribution1.Sigma)/(distribution1.Prior*distribution2.Sigma))+(distribution1.Mean^2)*(distribution2.Sigma^2) - (distribution2.Mean^2)*(distribution1.Sigma^2);
